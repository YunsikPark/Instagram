...
@receiver(post_delete, sender=PostLike, dispatch_uid='posltike_delete_update_like_count')
def update_post_like_count(sender, instance, **kwargs):
    uid = kwargs['signal'].receivers[0][0][0]
    print(uid)
    if uid == 'postlike_save_update_like_count':
